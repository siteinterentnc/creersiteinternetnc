...
const Footer11 = (props) => {
  return (
    <footer className="footer11-footer1 thq-section-padding">
          ...
          <div className="footer11-links">
            <div className="footer11-column1">
              ...
              <div className="footer11-footer-links">
                <span className="footer11-link1 thq-body-small">
                  {props.link1}
                </span>
                <span className="footer11-link2 thq-body-small">
                  {props.link2}
                </span>
                <span className="footer11-link3 thq-body-small">
                  {props.link3}
                </span>
                <span className="footer11-link4 thq-body-small">
                  {props.link4}
                </span>
                <span className="footer11-link5 thq-body-small">
                  {props.link5}
                </span>
              </div>
            </div>
            <div className="footer11-column2">
              <strong className="footer11-column2-title thq-body-large">
                {props.column2Title}
              </strong>
              <div className="footer11-footer-links1">
                <span className="footer11-link6 thq-body-small">
                  {props.link6}
                </span>
                <span className="thq-body-small">{props.link7}</span>
                <span className="footer11-link8 thq-body-small">
                  {props.link8}
                </span>
                <span className="footer11-link9 thq-body-small">
                  {props.link9}
                </span>
                <span className="footer11-link10 thq-body-small">
                  {props.link10}
                </span>
              </div>
            </div>
              ...
              <div className="footer11-social-links">
                ...
                <div className="footer11-link1">
                  <img
                    ...
                    className="footer11-platform-tik-tok-color-original"
                  />
        ...
        <div className="footer11-credits">
          ...
          <div className="footer11-row">
            ...
            <div className="footer11-footer-links2">
              <span className="footer11-link11 thq-body-small">
                {props.privacyLink}
              </span>
              <span className="footer11-link12 thq-body-small">
                {props.termsLink}
              </span>
              <span className="footer11-link13 thq-body-small">
                {props.cookiesLink}
              </span>
            </div>
          </div>
...
Footer11.defaultProps = {
  ...
  platformTikTokColorOriginalSrc:
    '/external/platformtiktokcolororiginal3162-skth.svg',
