          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              ...
              <div className="footer1-footer-links">
                <span className="footer1-link1 thq-body-small">
                  {props.link1}
                </span>
                <span className="footer1-link2 thq-body-small">
                  {props.link2}
                </span>
                <span className="footer1-link3 thq-body-small">
                  {props.link3}
                </span>
                <span className="footer1-link4 thq-body-small">
                  {props.link4}
                </span>
            ...
            <div className="footer1-column2">
              <strong className="footer1-column2-title thq-body-large">
                {props.column2Title}
              </strong>
              <div className="footer1-footer-links1">
                <span className="footer1-link6 thq-body-small">
                  {props.link6}
                </span>
                <span className="thq-body-small">{props.link7}</span>
                <span className="footer1-link8 thq-body-small">
                  {props.link8}
                </span>
                <span className="footer1-link9 thq-body-small">
                  {props.link9}
                </span>
                <span className="footer1-link10 thq-body-small">
                  {props.link10}
                </span>
              </div>
            </div>
              ...
              <div className="footer1-social-links">
                ...
                <div className="footer1-link1">
                  <img
                    ...
                    className="footer1-platform-tik-tok-color-original"
                  />
